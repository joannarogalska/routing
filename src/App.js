            ...
            <BrowserRouter>
                <div className="App">
                    <header>
                        ...
                        <nav>
                            <ul>
                                <li><NavLink to="/courses" exact activeClassName='my-active' activeStyle={{color: '#fa923f', textDecoration: 'underline'}}>Courses</NavLink></li>
                                <li><NavLink to="/users" exact activeClassName='my-active' activeStyle={{color: '#fa923f', textDecoration: 'underline'}}>Users</NavLink></li>
                            </ul>
                        </nav>
                    </header>
                    <Switch>
